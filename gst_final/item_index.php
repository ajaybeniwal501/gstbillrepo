...
<head>
    ...
    <meta charset="utf-8">
    <title>Item's Informations </title>
...
<h3>Item's Informations</h3> <hr />
<a href="item_insert.php"><button class="w3-button w3-indigo"> Insert Item</button></a>
 <br>
...
<tbody>
<?php
$sql = "SELECT item_code,item_name,item_desc,id from item where user_id='$u_id'";
...
?>
    ...
    <td><?php echo htmlentities($result->item_desc);?></td>
   
        
<td><a href="item_update.php?id=<?php echo htmlentities($result->id);?>"><button class="btn btn-primary btn-xs">&#9997;</button></a></td>
<td><a href="item_index.php?del=<?php echo htmlentities($result->id);?>"><button class="btn btn-primary btn-xs" onClick="return confirm('Do you really want to delete');">&#10006;</button></a></td>
    </tr>
<?php
$cnt++;
}} ?>
