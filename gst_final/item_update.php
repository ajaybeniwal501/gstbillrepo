...
$sql = "SELECT item_code,item_name,item_desc from item where id=:uid";
...
<input type="text" name="item_code" value="<?php echo htmlentities($result->item_code);?>"  required>
</div>
<div class="w3-third w3-container"><b>Item Name</b>
<input type="text" name="item_name" value="<?php echo htmlentities($result->item_name);?>"  required>
</div>
</div>
<div class="w3-row">

<div class="w3-third w3-container"><b>Item Description</b>
<input type="text" name="item_desc" value="<?php echo htmlentities($result->item_desc);?>" required>
</div>
...
$sql="update item set item_code=:code,item_name=:name,item_desc=:desc where id=:uid";
$query = $dbh->prepare($sql);
