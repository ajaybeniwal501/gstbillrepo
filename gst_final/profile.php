...
<?php echo "$username"; ?>
    ...
    -->
      ...
      <div class="w3-center"><br>
        ...
        <img src="images/avatar2.png" alt="Avatar" style="width:15% " class="w3-circle w3-margin-bottom">
...
foreach($results as $result)
{
    ...
    <a> <?php echo htmlentities($result->name);?></a> <br> <br>

            
          <label><b>Username: </b></label>
            
    <a><?php echo htmlentities($result->username);?></a> <br> <br>

           <label><b>E-Mail id: </b></label>
            
    <a><?php echo htmlentities($result->email);?></a> <br> <br>

           <label><b>Accounnt Created :</b></label>
            
    <a><?php echo htmlentities($result->created_at);?></a> <br> <br>
