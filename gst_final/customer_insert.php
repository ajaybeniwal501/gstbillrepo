...
<div class="row">
<div class="w3-container">
<h3>Insert Record Of Customer</h3>
<hr />
</div>
</div>
...
<input type="text" name="contact_number" maxlength="10" required>
</div>
</div>
    <div class="w3-row">
<div class="w3-third w3-container"><b>Customer GSTIN Number</b>
<input type="text" name="customer_gstin"  required>
</div>
<div class="w3-third w3-container"><b>Fax Number</b>
<input type="text" name="fax_number"  maxlength="10" required>
</div>
</div>
<div class="w3-row">
...
<input type="submit" name="insert" value="Submit"> &nbsp;
    ...
    <input type="submit" onclick="window.location.href = 'customer_index.php';" value="Cancel"/>
...
$sql="INSERT INTO tblusers(name,customer_no,email,contact_no,customer_gst,fax_number,address,user_id) VALUES(:name,:customerno,:email,:contactno,:customergst,:fax,:address,'$u_id')";
